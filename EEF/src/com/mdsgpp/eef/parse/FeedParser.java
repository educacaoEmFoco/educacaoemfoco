...
public class FeedParser extends DefaultHandler {
	...
	public Feed parse(InputStream is) {
        ...
        /* To every tag, we define the desired action to be performed, for example:
           When the 'channel' element is opened */
        ...
        // When the 'title' element (inside 'item') is closed, we can get the text
