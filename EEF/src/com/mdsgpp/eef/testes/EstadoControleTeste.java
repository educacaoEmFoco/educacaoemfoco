...
public class EstadoControleTeste extends AndroidTestCase{
	...
	public void setUp() throws Exception {
		...
		this.informacoes.put("ideb_fundamental_final", "Ensino Fundamental (s�ries finais): "+dfPorcentagem.format(4.09999999999854));
		this.informacoes.put("ideb_ensino_medio","Ensino M�dio: " + dfPorcentagem.format(3.5) + "" );	
		this.informacoes.put("ideb_fundamental_inicial", "Ensino Fundamental (S�ries iniciais): " + dfPorcentagem.format(4.5) + "");
