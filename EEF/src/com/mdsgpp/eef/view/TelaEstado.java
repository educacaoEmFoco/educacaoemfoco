...
public class TelaEstado extends Activity {
	...
	private void preencheCamposTexto(HashMap<String, String> informacoes) {
		...
		textViewParticipacaoPib.setText(informacoes.get
			("percentual_participacao_pib"));
		textViewQuantidadeProjetosCienciaTecnologia.setText(informacoes.get
			("projetos_ciencia_tecnologia"));
		textViewValorProjetosCienciaTecnologia.setText(informacoes.get
			("valor_ciencia_tecnologia"));
		textViewFundamentalIdeb.setText(informacoes.get
			("ideb_fundamental_final"));
		textViewEnsinoMedioIdeb.setText(informacoes.get("ideb_ensino_medio"));
		textViewIniciaisIdeb.setText(informacoes.get
			("ideb_fundamental_inicial"));
		textViewQuantidadePrimeirosProjetos.setText(informacoes.get
			("quantidade_primeiros_projetos"));
		textViewValorPrimeirosProjetos.setText(informacoes.get
			("valor_primeiros_projetos"));
	    textViewQuantidadePesquisa.setText(informacoes.get
	    	("quantidade_projeto_cnpq"));
		textViewValoresPesquisa.setText(informacoes.get("valor_projetos_cnpq"));
		textViewQuantidadeJovensPesquisadores.setText(informacoes.get
			("quantidade_projeto_jovens_pesquisadores"));
		textViewValorJovensPesquisadores.setText(informacoes.get
			("valor_projetos_jovens_pesquisadores"));
		textViewQuantidadeProjetosIniciacao.setText(informacoes.get
			("quantidade_projetos_inct"));
		textViewValorProjetosIniciacao.setText(informacoes.get
			("valor_projetos_inct"));
		
		textViewCensoIniciaisFundamental.setText(informacoes.get
			("censo_anos_iniciais_fundamental"));
		textViewCensoFinaisFundamental.setText(informacoes.get
			("censo_anos_finais_fundamental"));
		textViewCensoMedio.setText(informacoes.get
			("censo_ensino_medio"));
		textViewCensoEjaFundamental.setText(informacoes.get
			("censo_eja_fundamental"));
		textViewCensoEjaMedio.setText(informacoes.get("censo_eja_medio"));
		textViewMediaAlunosPorTurmaFundamental.setText(informacoes.get
			("alunos_por_turma_ensino_fundamental"));
		textViewMediaAlunosPorTurmaMedio.setText(informacoes.get
			("alunos_por_turma_ensino_medio"));
		textViewMediaHorasAulaFundamental.setText(informacoes.get
			("horas_aula_ensino_fundamental"));
		textViewMediaHorasAulaMedio.setText(informacoes.get
			("horas_aula_ensino_medio"));
		textViewTaxaDistorcaoIdadeSerieFundamental.setText(informacoes.get
			("taxa_distorcao_fundamental"));
		textViewTaxaDistorcaoIdadeSerieMedio.setText(informacoes.get
			("taxa_distorcao_medio"));
		textViewTaxaDeAproveitamentoFundamental.setText(informacoes.get
			("taxa_aprovacao_fundamental"));
		textViewTaxaDeAproveitamentoMedio.setText(informacoes.get
			("taxa_aprovacao_medio"));
		textViewTaxaDeAbandonoFundamental.setText(informacoes.get
			("taxa_aprovacao_fundamental"));
		textViewTaxaDeAbandonoMedio.setText(informacoes.get
			("taxa_aprovacao_medio"));
	...
	private void setImagem(int posicao) {
		...
		int idBandeira = getResources().getIdentifier(bandeiras[posicao],
