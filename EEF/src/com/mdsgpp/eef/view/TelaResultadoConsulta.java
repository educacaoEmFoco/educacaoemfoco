...
public class TelaResultadoConsulta extends Activity {
	...
	private void capturaInformacoes() {
		...
		bPrimeirosProjetos = intent.getBooleanExtra("CB_PRIMEIROS_PROJETOS", 
			false);
		...
		bProjetosIniciacao = intent.getBooleanExtra("CB_PROJETOS_INICIACAO",
			false);
	...
	private void preencheCamposTexto(HashMap<String, String> informacoes1,
		...
		textViewQuantidadeProjetosCienciaTecnologia1.setText(informacoes1.get
			("projetos_ciencia_tecnologia"));
		textViewValorProjetosCienciaTecnologia1.setText(informacoes1.get
			("valor_ciencia_tecnologia"));
		textViewFundamentalIdeb1.setText(informacoes1.get
			("ideb_fundamental_final"));
		textViewEnsinoMedioIdeb1.setText(informacoes1.get("ideb_ensino_medio"));
		textViewIniciaisIdeb1.setText(informacoes1.get
			("ideb_fundamental_inicial"));
		textViewQuantidadePrimeirosProjetos1.setText(informacoes1.get
			("quantidade_primeiros_projetos"));
		textViewValorPrimeirosProjetos1.setText(informacoes1.get
			("valor_primeiros_projetos"));
		textViewQuantidadePesquisa1.setText(informacoes1.get
			("quantidade_projeto_cnpq"));
		textViewValoresPesquisa1.setText(informacoes1.get
			("valor_projetos_cnpq"));
		textViewQuantidadeJovensPesquisadores1.setText(informacoes1.get
			("quantidade_projeto_jovens_pesquisadores"));
		textViewValorJovensPesquisadores1.setText(informacoes1.get
			("valor_projetos_jovens_pesquisadores"));
		textViewQuantidadeProjetosIniciacao1.setText(informacoes1.get
			("quantidade_projetos_inct"));
		textViewValorProjetosIniciacao1.setText(informacoes1.get
			("valor_projetos_inct"));
		textViewCensoIniciaisFundamental1.setText(informacoes1.get
			("censo_anos_iniciais_fundamental"));
		textViewCensoFinaisFundamental1.setText(informacoes1.get
			("censo_anos_finais_fundamental"));
		textViewCensoMedio1.setText(informacoes1.get("censo_ensino_medio"));
		textViewCensoEjaFundamental1.setText(informacoes1.get
			("censo_eja_fundamental"));
		textViewCensoEjaMedio1.setText(informacoes1.get("censo_eja_medio"));
		textViewMediaAlunosPorTurmaFundamental1.setText(informacoes1.get
			("alunos_por_turma_ensino_fundamental"));
		textViewMediaAlunosPorTurmaMedio1.setText(informacoes1.get
			("alunos_por_turma_ensino_medio"));
		textViewMediaHorasAulaFundamental1.setText(informacoes1.get
			("horas_aula_ensino_fundamental"));
		textViewMediaHorasAulaMedio1.setText(informacoes1.get
			("horas_aula_ensino_medio"));
		textViewTaxaDistorcaoIdadeSerieFundamental1.setText(informacoes1.get
			("taxa_distorcao_fundamental"));
		textViewTaxaDistorcaoIdadeSerieMedio1.setText(informacoes1.get
			("taxa_distorcao_medio"));
		textViewTaxaDeAproveitamentoFundamental1.setText(informacoes1.get
			("taxa_aprovacao_fundamental"));
		textViewTaxaDeAproveitamentoMedio1.setText(informacoes1.get
			("taxa_aprovacao_medio"));
		textViewTaxaDeAbandonoFundamental1.setText(informacoes1.get
			("taxa_aprovacao_fundamental"));
		textViewTaxaDeAbandonoMedio1.setText(informacoes1.get
			("taxa_aprovacao_medio"));
		...
		textViewParticipacaoPib2.setText(informacoes2.get
		...
		textViewEnsinoMedioIdeb2.setText(informacoes2.get
		...
		textViewValoresPesquisa2.setText(informacoes2.get
		...
		textViewCensoIniciaisFundamental2.setText(informacoes2.get
			("censo_anos_iniciais_fundamental").split(":")[1]);
		textViewCensoFinaisFundamental2.setText(informacoes2.get
			("censo_anos_finais_fundamental").split(":")[1]);
		textViewCensoMedio2.setText(informacoes2.get
			("censo_ensino_medio").split(":")[1]);
		textViewCensoEjaFundamental2.setText(informacoes2.get
			("censo_eja_fundamental").split(":")[1]);
		textViewCensoEjaMedio2.setText(informacoes2.get
			("censo_eja_medio").split(":")[1]);
		textViewMediaAlunosPorTurmaFundamental2.setText(informacoes2.get
			("alunos_por_turma_ensino_fundamental").split(":")[1]);
		textViewMediaAlunosPorTurmaMedio2.setText(informacoes2.get
			("alunos_por_turma_ensino_medio").split(":")[1]);
		textViewMediaHorasAulaFundamental2.setText(informacoes2.get
			("horas_aula_ensino_fundamental").split(":")[1]);
		textViewMediaHorasAulaMedio2.setText(informacoes2.get
			("horas_aula_ensino_medio").split(":")[1]);
		textViewTaxaDistorcaoIdadeSerieFundamental2.setText(informacoes2.get
			("taxa_distorcao_fundamental").split(":")[1]);
		textViewTaxaDistorcaoIdadeSerieMedio2.setText(informacoes2.get
			("taxa_distorcao_medio").split(":")[1]);
		textViewTaxaDeAproveitamentoFundamental2.setText(informacoes2.get
			("taxa_aprovacao_fundamental").split(":")[1]);
		textViewTaxaDeAproveitamentoMedio2.setText(informacoes2.get
			("taxa_aprovacao_medio").split(":")[1]);
		textViewTaxaDeAbandonoFundamental2.setText(informacoes2.get
			("taxa_aprovacao_fundamental").split(":")[1]);
		textViewTaxaDeAbandonoMedio2.setText(informacoes2.get
			("taxa_aprovacao_medio").split(":")[1]);
	...
	public void escondeCamposDeTexto() {
		...
		setVisibility(textViewQuantidadeProjetosCienciaTecnologia1,
			bProjetosDifusao);
		setVisibility(textViewValorProjetosCienciaTecnologia1,
			bProjetosDifusao);
		setVisibility(textViewQuantidadeProjetosCienciaTecnologia2,
			bProjetosDifusao);
		setVisibility(textViewValorProjetosCienciaTecnologia2, 
			bProjetosDifusao);
		...
		setVisibility(textViewTaxaDistorcaoIdadeSerieFundamental1,
			bTaxaDistorcao);
		setVisibility(textViewTaxaDistorcaoIdadeSerieMedio1, bTaxaDistorcao);
		setVisibility(textViewTaxaDistorcaoIdadeSerieFundamental2,
			bTaxaDistorcao);
		...
		try {
			...
			setVisibility(textViewProgramaPrimeirosProjetos2,
				bPrimeirosProjetos);
	...
	public void capturaBandeiras(int posicaoEstado1, int posicaoEstado2) {
		...
		imageViewBandeira01 = (ImageView) 
			findViewById(R.id.imageView_bandeiras1);
		int idBandeira01 = getResources().getIdentifier
			(bandeiras[posicaoEstado1], "drawable", getPackageName());
		imageViewBandeira01.setImageResource(idBandeira01);
	
		imageViewBandeira02 = (ImageView) 
			findViewById(R.id.imageView_bandeiras2);
		int idBandeira02 = getResources().getIdentifier
			(bandeiras[posicaoEstado2], "drawable", getPackageName());
